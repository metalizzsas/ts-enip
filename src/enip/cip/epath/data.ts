namespace epath.data
{
     ...
     * @returns {buffer}
     */
    export function build(data: string | Buffer, ANSI = true): Buffer
    {
        // Build Element Segment If Int
        if (typeof data === 'string') return elementBuild(parseInt(data));
     ...
     * @returns {buffer}
     */
    export function symbolicBuild(data: string | Buffer, ANSI = true): Buffer {
        // Initialize Buffer
     ...
     * @returns {buffer}
     */
    export function elementBuild(data: number): Buffer{
