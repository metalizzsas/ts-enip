...
(function (ConnectionManager) {
    ...
    let Owner;
    (function (Owner) {
        Owner[Owner["Exclusive"] = 0] = "Exclusive";
        Owner[Owner["Multiple"] = 1] = "Multiple";
    })(Owner = ConnectionManager.Owner || (ConnectionManager.Owner = {}));
    ;
    /** lookup for the Connection Type (Vol.1 - Table 3-5.8 Field 14,13) */
    let ConnectionType;
    (function (ConnectionType) {
        ConnectionType[ConnectionType["Null"] = 0] = "Null";
        ConnectionType[ConnectionType["Multicast"] = 1] = "Multicast";
        ConnectionType[ConnectionType["PointToPoint"] = 2] = "PointToPoint";
        ConnectionType[ConnectionType["Reserved"] = 3] = "Reserved";
    })(ConnectionType = ConnectionManager.ConnectionType || (ConnectionManager.ConnectionType = {}));
    ;
    ...
    (function (Priority) {
        ...
        Priority[Priority["Scheduled"] = 2] = "Scheduled";
        Priority[Priority["Urgent"] = 3] = "Urgent";
    })(Priority = ConnectionManager.Priority || (ConnectionManager.Priority = {}));
    ;
    /** lookup for the fixed or variable parameter (Vol.1 - Table 3-5.8 Field 9) */
    let FixedVar;
    (function (FixedVar) {
        FixedVar[FixedVar["Fixed"] = 0] = "Fixed";
        FixedVar[FixedVar["Variable"] = 1] = "Variable";
    })(FixedVar = ConnectionManager.FixedVar || (ConnectionManager.FixedVar = {}));
    ;
    /**
     * Build for Object specific connection parameters (Vol.1 - Table 3-5.8)
     */
    function build_connectionParameters(owner, type, priority, fixedVar, size) {
        if (owner != 0 && owner != 1)
    ...
    ConnectionManager.build_connectionParameters = build_connectionParameters;
    ;
     ...
     */
    function generateEncodedTimeout(timeout) {
    ...
    ConnectionManager.generateEncodedTimeout = generateEncodedTimeout;
    ;
    /**
     ...
     */
    function build_forwardOpen(otRPI = 8000, netConnParams = 0x43f4, timeOutMs = 1000, timeOutMult = 32, connectionSerial = 0x4242) {
    ...
    ConnectionManager.build_forwardOpen = build_forwardOpen;
    ;
    /**
     ...
     */
    function build_forwardClose(timeOutMs = 1000, vendorOrig = 0x3333, serialOrig = 0x1337, connectionSerial = 0x4242) {
        if (timeOutMs <= 900 || typeof timeOutMs !== "number")
    ...
    ConnectionManager.build_forwardClose = build_forwardClose;
    ;
    function getRandomInt(max) {
        return Math.floor(Math.random() * Math.floor(max));
    }
})(ConnectionManager = exports.ConnectionManager || (exports.ConnectionManager = {}));
